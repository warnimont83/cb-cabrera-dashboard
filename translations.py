...
translations = {
    'ca': {
        ...
        'rival_teams_analysis': 'Anàlisi d\'equips rivals',
        'scout_your_opponents': 'Analitza els teus oponents',
        ...
        'opponent_team_analysis': 'Anàlisi de l\'equip oponent',
        'rival_detail': 'Detall del rival',
        'players_tracked': 'Jugadors registrats',
        'total_points_scored': 'Punts totals anotats',
        'opponent_teams': 'Equips oponents',
        'search_for_rival': 'Cercar un equip rival...',
        'team_name': 'Nom de l\'equip',
        'actions': 'Accions',
        'view_details': 'Veure detalls',
        'no_rival_teams_found': 'No s\'han trobat equips rivals',
        'no_opponents_recorded': 'No s\'han registrat oponents per la temporada seleccionada',
        'back_to_home': 'Tornar a l\'inici',
        'back_to_rivals': 'Tornar als rivals',
        'limited_data': 'Dades limitades',
        'limited_data_warning': 'Això mostra només partits contra equips del CB Cabrera.',
        'scout_key_players': 'Analitza els jugadors clau d\'aquest equip rival',
        'no_player_stats_available': 'No hi ha estadístiques de jugadors disponibles',
        'no_recorded_player_data': 'Aquest equip rival no té dades de jugadors registrades',
        'match_history_against': 'Historial de partits contra',
        'we_won': 'Hem guanyat',
        'we_lost': 'Hem perdut',
    ...
    'en': {
        ...
        'rival_teams_analysis': 'Rival Teams Analysis',
        'scout_your_opponents': 'Scout your opponents',
        ...
        'opponent_team_analysis': 'Opponent Team Analysis',
        ...
        'search_for_rival': 'Search for a rival team...',
        'team_name': 'Team Name',
        'actions': 'Actions',
        'view_details': 'View Details',
        'no_rival_teams_found': 'No rival teams found',
        'no_opponents_recorded': 'No opponents recorded for the selected season',
        'back_to_home': 'Back to home',
        'back_to_rivals': 'Back to rivals',
        'limited_data': 'Limited Data',
        'limited_data_warning': 'This shows only matches against CB Cabrera teams.',
        'scout_key_players': 'Scout key players from this rival team',
        'no_player_stats_available': 'No player statistics available',
        'no_recorded_player_data': 'This rival team has no recorded player data',
        'match_history_against': 'Match History Against',
        'we_won': 'We Won',
        'we_lost': 'We Lost',
